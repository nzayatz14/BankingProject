...
public:
	InternalAccount(string,ExternalAccount&);	//constructor
	...
	void setAccountType(string a);	//function sets the account type
	void setMoney(double m);	//function sets the money
	void setExternalAccount(ExternalAccount m);	//function sets the corresponding external account
